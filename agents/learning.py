"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for fungal-antigen-triage-agent.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Fungal Antigen Triage Agent"):
