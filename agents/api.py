"""
FastAPI REST API Server for Fungal Antigen Triage Agent.
"""
...
app = FastAPI(
    title="Fungal Antigen Triage Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "fungal-antigen-triage-agent", "domain": "Antimicrobial Stewardship & Microbiology", "standard": "CLSI M100 / EUCAST / CDC NHSN Guidelines", "version": "3.0.0-ENTERPRISE"}
