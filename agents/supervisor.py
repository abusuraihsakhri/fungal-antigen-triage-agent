"""
Supervisor Orchestrator & Operations Intelligence for Fungal Antigen Triage Agent.
...
class SystemSupervisor:
    """Master Distributed Component Coordinator for Fungal Antigen Triage Agent."""
    ...
    def __init__(self, model_provider: str = "mock"):
        ...
        self.llm = LLMFactory.create(model_provider, system_name="Fungal Antigen Triage Agent")
    ...
    def query_supervisory_chat(self, query: str) -> str:
        ...
        prompt = f"Supervisor inquiry for Fungal Antigen Triage Agent under CLSI M100 / EUCAST / CDC NHSN Guidelines: {query}"
